...
const Community = () => {
  ...
  return !loading ?  (
    ...
    <div className='flex items-center justify-center h-full'><span className='w-10 h-10 my-1 rounded-full border-3 border-primary border-t-transparent animate-spin'></span></div>
  )
}
